...
def train_esd(prompt, train_method, start_guidance, negative_guidance, iterations, lr, config_path, ckpt_path, mask_path, diffusers_config_path, devices, seperator=None, image_size=512, ddim_steps=50):
    '''
    ...
    for i in pbar:
        ...
        start_code = torch.randn((1, 4, int(image_size / 8), int(image_size / 8))).to(devices[0])
