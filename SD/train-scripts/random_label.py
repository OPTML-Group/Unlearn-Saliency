...
def random_label(class_to_forget, train_method, alpha, batch_size, epochs, lr, config_path, ckpt_path, mask_path, diffusers_config_path, device, image_size=512, ddim_steps=50):
    ...
    random_descriptions = [
        'an image of a tench', 'an image of a English springer', 'an image of a cassette player', 
        'an image of a chain saw', 'an image of a church', 'an image of a French horn', 
        'an image of a gas pump', 'an image of a golf ball', 'an image of a parachute'
    ]
    ...
    for epoch in range(epochs):
        ...
        # with tqdm(total=10) as time:
            ...
            # for i in range(1):
                ...
                # truck -> others
                random_prompts = [random.choice(random_descriptions) for label in forget_labels]
                ...
                random_input, random_emb = model.get_input(random_batch, model.first_stage_key)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mask_path', help='mask path for stable diffusion v1-4', type=str, required=False, default=None)
    ...
    random_label(classes, train_method, alpha, batch_size, epochs, lr, config_path, ckpt_path, mask_path, diffusers_config_path, device, image_size, ddim_steps)
