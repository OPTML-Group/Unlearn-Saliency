...
from dataset import setup_model, setup_remain_data, setup_forget_data, setup_forget_nsfw_data
...
def nsfw_removal(train_method, alpha, batch_size, epochs, lr, config_path, ckpt_path, mask_path, diffusers_config_path, device, image_size=512, ddim_steps=50):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', help='cuda devices to train on', type=str, required=False, default='0,0')
    ...
    nsfw_removal(train_method=train_method, alpha=alpha, batch_size=batch_size, epochs=epochs, lr=lr, config_path=config_path, ckpt_path=ckpt_path, mask_path=mask_path, diffusers_config_path=diffusers_config_path, device=device, image_size=image_size, ddim_steps=ddim_steps)
