...
def save_gradient_ratio(data_loaders, model, criterion, args):
    ...
    for i in threshold_list: 
        ...
        torch.save(sigmoid_soft_dict, os.path.join(args.save_dir, 'sigmoid_soft_{}.pt'.format(i)))
        torch.save(tanh_soft_dict, os.path.join(args.save_dir, 'tanh_soft_{}.pt'.format(i)))
